...
- (CGFloat)headerHeightForSection:(NSInteger)section
{
    ...
    Class headerNibClass = sectionItem.headerNibClass;
    ...
    }else if ([headerNibClass isSubclassOfClass:[CCBaseTableHeaderView class]]){
        return [headerNibClass headerViewHeightForData:sectionItem.sectionHeaderData];
    }
    return 0.0f;
}
...
- (CGFloat)footerHeightForSection:(NSInteger)section
{
    ...
    }else if ([headerNibClass isSubclassOfClass:[CCBaseTableFooterView class]]){
        return [headerNibClass footerViewHeightForData:sectionItem.sectionHeaderData];
    }
    return 0.0f;
}
